...
import com.example.testpicasso.data.Destination
object DestinationRepository {
     ...
     fun getMerlo(): Destination {
        return Destination(
            ...
            listOf("https://www.welcomeargentina.com/sanluis/imagenes/san-luis-plaza.jpg", "https://sanluis24.com.ar/wp-content/uploads/2023/01/marli.jpg", "https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Ruta_en_Merlo.jpg/294px-Ruta_en_Merlo.jpg")
        )
    }
    ...
    fun getColonia(): Destination {
        return Destination(
            ...
            listOf("https://elsouvenir.com/wp-content/uploads/2020/12/colonia-uruguay-header.jpg","https://upload.wikimedia.org/wikipedia/commons/1/10/Calle_de_los_Suspiros%2C_Colonia_del_Sacramento%2C_Uruguay_-_panoramio.jpg", "https://imgar.zonapropcdn.com/avisos/1/00/51/01/85/96/720x532/1851485389.jpg")
        )
    }
